...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(487024, remapJar)
        file.displayName = "[${project.extra["minecraft_version"] as String}] Expanded Weapon Enchanting"
...
modrinth {
    ...
    projectId.set("expanded-weapon-enchanting")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Expanded Weapon Enchanting")
    dependencies {
